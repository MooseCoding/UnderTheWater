...
import org.firstinspires.ftc.teamcode.dairy.subsystems.Lift.Companion.atTarget
...
import org.firstinspires.ftc.teamcode.dairy.subsystems.Lift.Companion.goTo
...
class OuttakeTuning: OpMode() {
    ...
    override fun loop() {
        ...
        if(Lift.atTarget() && Lift.target == 0.0 && Lift.outtake1!!.currentPosition != 0) {
            Lift.outtake1!!.mode = DcMotor.RunMode.STOP_AND_RESET_ENCODER
            Lift.outtake2!!.mode = DcMotor.RunMode.STOP_AND_RESET_ENCODER
            Lift.outtake1!!.mode = DcMotor.RunMode.RUN_WITHOUT_ENCODER
            Lift.outtake2!!.mode = DcMotor.RunMode.RUN_WITHOUT_ENCODER
        }
