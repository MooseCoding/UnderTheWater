    ...
    fun lift(lT:Int) {
        Sequential(
            ...
            Parallel(
                ...
                IntakeClaw.INSTANCE.closeClaw(), // 200 ms // 200 ms // ~600 ms
            ),
            OuttakeClaw.INSTANCE.clawOpen(),
        ...
        when (pathState) {
            ...
            1 -> {
                if(isClose()) {
                    ...
                    if(IntakeClaw.claw_pos == IntakeClaw.claw_partial && Intake.intake!!.currentPosition < 20) {
            ...
            2 ->   {
                if(isClose()) {
                    if(!first) {
                        IntakeClaw.INSTANCE.closeClaw().schedule()
                        dropAndDown()
                    }
